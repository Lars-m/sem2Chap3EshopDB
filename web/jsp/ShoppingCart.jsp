...
<%
  ...
  Map<String, CartItem> shoppingCart = (Map<String, CartItem>)session.getAttribute("shoppingCart");
...
<%
        ...
        for (CartItem item : shoppingCart.values()) {
          itemPrice = Math.round( Integer.parseInt(item.getQuantity()) * item.getPrice() * 100.) / 100.;
  ...
  %>
        ...
        <tr>
          <td colspan="6" class="center"><a class="link1"
            href="ctrl?action=checkOut">Check Out</a></td>
          </tr>
        </table>
      </div>
<%
